# Path to the image used to test allowedFile with small resolution
API_IMAGE1 = "allowedFile_test1.png"
# Path to the image used to test allowedFile with too large file
API_IMAGE2 = "allowedFile_test2.png"
# Path to the image used to test allowedFile with wrong format
